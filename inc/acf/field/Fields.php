...
class Fields
{
     ...
     */
    public static function get_by_key( string $field_key, bool $validate_exist = false ) : Field
    {
        $field = static::create_using_key( $field_key );
     ...
     * @return  Field                   Field instance.
     */
    public static function get_by_id( int $field_id, bool $validate_exist = false ) : Field
    {
        $field_key = static::get_key_by_id( $field_id );

        return static::get_by_key( $field_key, $validate_exist );
    }
     ...
     * @return  Field                   Field instance.
     */
    public static function get_by_name( string $field_name, bool $validate_exist = false ) : Field
    {
        $field_object = get_field_object( $field_name, $context );

        return static::get_by_key( $field_object['key'], $validate_exist );
    }
    ...
    public static function get_all() : array
    {
        ...
        foreach ( static::get_fields_posts_query()->posts as $field_post )
        {
            ...
            $fields[] = static::create_using_key( $field_key );
        }
     ...
     * @return  Field               Field instance.
     */
    protected static function create_using_key( string $field_key ) : Field
    {
